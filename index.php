...
<div class="topnav">
  ...
  <a href="checkoutwede.php">Check Out</a>
</div> 
...
<a id="btnCheckOut" href="checkoutwede.php?action=CheckOut">Check Out</a>
<?php
...
<div id="product-grid">
	<div class="txt-heading">Available books for sale:</div>
	<?php
	...
	?>
		<div class="product-item">
			...
			<div class="product-image"><img src="<?php echo $product_array[$key]["image"]; ?>" width="300" height="400"></div>
